...
export default function Delete(props) {
    async function Confirm() {
        await axios.delete(`http://localhost:3000/api/vehicle/delete?id=${props.vehicle.vehicleId}`);
    }
    ...
    if(props) {
        return (
            <>
                ...
                <Link href="/vehicles"><Button onClick={Confirm}>Confirm Deletion</Button></Link>
            </>
        )
    }else {
        return(
